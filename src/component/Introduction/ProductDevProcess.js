...
// A reusable card component that toggles its content
...
const ProductProcess = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Product Development Process</h1>
      ...
      {/* 4. Product Launch & Go-To-Market Strategy */}
